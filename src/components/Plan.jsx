  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='flex flex-col h-full justify-center'>
        ...
        <p className='pb-6'>
          Plan your next beach escape to the breathtaking shores of Bali, Indonesia. Discover white sands, turquoise waters, and vibrant culture. Get ready for a tropical paradise!
        </p>
        <div>
