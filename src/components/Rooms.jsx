  ...
  return (
    <div className='max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4'>
      <div className='lg:top-20 relative lg:col-span-1 col-span-2'>
        ...
        <p className='pt-4'>
          Elegant interiors blend color, texture, and design to create exquisite rooms. Thoughtfully selected furniture, lighting, and decor add personality, comfort, and sophistication, making your home truly exceptional.
        </p>
      </div>
